...
class InlineViewComponentTest < ViewComponent::TestCase
  ...
  SLIM_RESULT = "<h1>Slim Component</h1><p><span style=\"color: green;\">html_safe strings work</span></p><p>&lt;span style=\"color: red\"&gt;unsafe HTML is escaped&lt;/span&gt;</p><h3>Hi I'm the insides.  Here's how I render HTML strings</h3>\n\n <p><span style=\"color: blue;\">Manually escape safe html with %==</span></p>\n <p>&lt;span style=\"color: red\"&gt;unsafe HTML is escaped&lt;/span&gt;</p>\n"
  ...
  def test_it_renders_slim
    assert_equal SLIM_RESULT, render_inline(SlimComponent.new(true)).to_s
  end
end
